// Widget pour afficher une grille 2x2 de photos (4 photos)
import 'dart:io';
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ui.Image>(
      ...
      builder: (context, snapshot) {
        ...
        final segmentHeight = stripHeight / 4;
          ...
          child: Padding(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final gridHeight = (availableHeight - whiteSeparatorWidth) / 2;
